...
class SimpleTextReplyer <T: OfficialAccount> (account: T, var textToReply: String, factor: Double = 0.9, nameInLog: String? = null): MessageReplyer<T>(account, factor, nameInLog){
